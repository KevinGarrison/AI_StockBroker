function CompanyChartGrafana({ ticker }) {
  const grafanaUrl = `http://localhost:3000/d-solo/eepq24k87rpc0e/new-dashboard?orgId=1&timezone=browser&theme=light&panelId=1&__feature.dashboardSceneSolo&var-ticker=${ticker}`;
